# Recreate the figure showing all the deployment info from the script "scripts/viz_for_flyway_Aug2022.R",
# in order to then stick it in the writing draft Rmd.
