...
# cowplot::save_plot(here("figures/figs_for_manuscript/post_march_2024/marginal_effects_plots2.tiff"), marginals)
# 
# ggsave(marginals, file=here("figures/figs_for_manuscript/post_march_2024/marginal_effects_plots1.tiff"),
#        dpi=300, compression="lzw")

# increasing the font makes the saved file not fit, and using aspect.ratio=1 also messes things up
