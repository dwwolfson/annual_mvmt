...
Average departure date from breeding territories in the autumn across years for all long-distance migrants (\>100 km) was 1 November with a standard deviation of 20 days, and yearly averages ranged from 25 October to 7 November (Fig. \@ref(fig:timing-vs-latitude-fig), Supplemental tables).
There was little evidence of a relationship between breeding latitude and autumn departure date (Fig. \@ref(fig:coefplot-fig)), but breeders left later, on average, than non-breeders or paired swans, and the difference between breeders and non-breeders was statistically significant (Fig. \@ref(fig:timing-vs-breeding-fig), Fig. \@(fig:coefplot-fig)), Supplemental tables). The relationship between spring arrival (i.e., for swans that traveled \>100 km during the non-breeding period and returned to within 10 km of their previous summer territory) and breeding latitude was statistically significant, with swans returning to their territories sooner at lower latitudes. The average spring arrival date across years was 5 March and yearly averages ranging from 2 March to 7 March (Fig. \@ref(fig:timing-vs-latitude-fig), Supplemental tables).
